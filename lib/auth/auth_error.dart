...
const Map<String, AuthError> authErrorMapping = {
  ...
  'email-already-in-use': AuthErrorEmailAlreadyInUser(),
...
class AuthErrorOperationNotAllowed extends AuthError {
  const AuthErrorOperationNotAllowed()
      : super(
          ...
          dialogText:
              'You cannot register using this method at the moment time!',
        );
}
...
@immutable
class AuthErrorEmailAlreadyInUser extends AuthError {
  const AuthErrorEmailAlreadyInUser()
      : super(
